#include <ESP8266WiFi.h>
  ...
  const char* serverUrl = "http://192.168.1.17/NodeMCU_RC522_Mysql/getUID.php"; // URL server
  const char* location = "Home1"; // Vị trí cố định cho NodeMCU này
  ...
  void loop() {
    ...
    if (WiFi.status() == WL_CONNECTED) {
      ...
      String postData = "UIDresult=" + cardUid + "&location=" + location;
